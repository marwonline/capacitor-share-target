 ...
 *
 * Code example for ObjectiveC https://stackoverflow.com/questions/42269842/share-extension-not-appearing-in-the-list-of-apps-on-capable-of-sharing-photo-on
 */
class ShareViewController: SLComposeServiceViewController {
    ...
    override func didSelectPost() {
        ...
        if let content = extensionContext!.inputItems[0] as? NSExtensionItem {
            ...
            // TODO: use text content: content.attributedContentText
